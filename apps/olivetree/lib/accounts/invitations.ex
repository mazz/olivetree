defmodule Olivetree.Accounts.Invitations do
  @moduledoc """
  Invitation system. Generate invites, validate them...

  Can be bypassed by setting the {:olivetree, :invitation_system} env variable
  ...
  """
  def enabled?, do: Application.get_env(:olivetree, :invitation_system)

  @doc """
  Enable the invitation system
  """
  def enable, do: Application.put_env(:olivetree, :invitation_system, true)

  @doc """
  Disable the invitation system
  """
  def disable, do: Application.put_env(:olivetree, :invitation_system, false)
  ...
  def send_invite(request = %InvitationRequest{}) do
    ...
    |> Olivetree.Mailer.Email.invitation_to_register()
  ...
  def generate_invites(number, token) do
    ...
    frontend_url = Application.fetch_env!(:olivetree, :frontend_url)
