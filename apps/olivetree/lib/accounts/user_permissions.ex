defmodule Olivetree.Accounts.UserPermissions do
  @moduledoc """
  ...
  @limitations_file Path.join(:code.priv_dir(:olivetree), "limitations.yaml")
  @external_resource @limitations_file
  @limitations Olivetree.Utils.load_yaml_config(@limitations_file)
