defmodule Olivetree.Authenticator.OAuth.Facebook do
  @moduledoc """
  OAuth2 for Facebook.
  Inspired by https://github.com/chrislaskey/oauth2_facebook
  """
  use OAuth2.Strategy
  alias Olivetree.Authenticator.ProviderInfos
  ...
  defp config do
    Application.get_env(:olivetree, :oauth)[:facebook]
  end
  ...
  defp app_id do
    Application.get_env(:olivetree, :oauth)[:facebook][:client_id]
  end

  defp app_secret do
    Application.get_env(:olivetree, :oauth)[:facebook][:client_secret]
  end
end
