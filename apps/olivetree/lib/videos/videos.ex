defmodule Olivetree.Videos do
  @moduledoc """
  The boundary for the Videos system.
  """

  import Ecto.Query, warn: false
  import Olivetree.Videos.MetadataFetcher
  import Olivetree.Videos.CaptionsFetcher
  import Olivetree.Actions.ActionCreator, only: [action_update: 2]
  ...
  @captions_fetcher Application.get_env(:olivetree, :captions_fetcher)
  ...
  defp get_metadata_fetcher(video_url) do
    cond do
      # Application.get_env(:olivetree, :use_test_video_metadata_fetcher) ->
