defmodule Olivetree.Actions.ReputationChangeConfigLoader do
  @moduledoc """
  ...
  def load(filename) do
    filename
    |> Olivetree.Utils.load_yaml_config()
    |> convert()
  end
  ...
  ## Examples
      ...
      iex> import Olivetree.Actions.ReputationChangeConfigLoader, only: [convert: 1]
