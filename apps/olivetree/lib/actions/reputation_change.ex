defmodule Olivetree.Actions.ReputationChange do
  @moduledoc """
  ...
  alias Olivetree.Actions.ReputationChangeConfigLoader
  ...
  # numerical value.
  @reputations_file Path.join(:code.priv_dir(:olivetree), "reputation_changes.yaml")
