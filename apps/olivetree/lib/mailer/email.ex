defmodule Olivetree.Mailer.Email do
  @moduledoc """
  ...
  use Bamboo.Phoenix, view: Olivetree.Mailer.View
  ...
  alias Olivetree.Actions.ReputationChange

  @sender_no_reply {"Olivetree", "no-reply@olivetree.app"}
  ...
  def welcome(user) do
    ...
    user
    |> user_email()
    |> subject(gettext_mail_user(user, "Welcome to olivetree.app!"))
  ...
  def reset_password_request(%ResetPasswordRequest{user: user, token: token, source_ip: ip}) do
    user
    |> user_email()
    |> subject(gettext_mail_user(user, "olivetree.app - Reset your password"))
  ...
  def reputation_loss(user) do
    user
    |> user_email()
    |> subject(gettext_mail_user(user, "About your recent loss of reputation on Olivetree"))
  ...
  defp invitation_subject(nil),
    do: gettext_mail("Your invitation to try Olivetree.app is ready!")

  defp invitation_subject(user = %User{}),
    do:
      gettext_mail_user(
        user,
        "%{name} invited you to try Olivetree.app!",
  ...
  defp base_email() do
    ...
    |> put_html_layout({Olivetree.Mailer.View, "_layout.html"})
    |> put_text_layout({Olivetree.Mailer.View, "_layout.text"})
  end
