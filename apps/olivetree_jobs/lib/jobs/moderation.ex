defmodule Olivetree.Jobs.Moderation do
  @moduledoc """
  ...
  ## Examples
    ...
    iex> import Olivetree.Jobs.Moderation
  ...
  defp process_entry(entry = %{action: %{type: :create, entity: entity}}) do
